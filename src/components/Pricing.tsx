        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="text-center mb-12">
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-display font-bold mb-4">
              Only Pay When You <span className="bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent animate-glow">Profit</span>
            </h2>
            ...
            <div className="relative p-8 md:p-12 rounded-3xl bg-card shadow-float border-2 border-primary/20">
              ...
              <div className="text-center mb-8">
                ...
                <div className="flex items-baseline justify-center gap-2 mb-4">
                  ...
                  <span className="text-xl text-muted-foreground">refundable deposit</span>
                </div>
              ...
              <div className="space-y-4 mb-8">
                <div className="p-4 rounded-xl bg-muted/50 border border-primary/10">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="font-semibold text-foreground mb-1">5% performance share</p>
                      <p className="text-sm text-muted-foreground">Only on actual sales generated through the platform</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="p-4 rounded-xl bg-accent/10 border border-accent/20">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="font-semibold text-foreground mb-1">Refund milestone</p>
                      <p className="text-sm text-muted-foreground">
                        Once you cross $100K in sales, we refund your entire deposit
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="p-4 rounded-xl bg-primary/5 border border-primary/10">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="font-semibold text-foreground mb-1">Legacy Bonus</p>
                      <p className="text-sm text-muted-foreground">
                        Join the 6-Figure Creator Circle with mastermind sessions, launch collaborations, and exclusive retreat invites
                      </p>
                    </div>
                  </div>
                </div>
              ...
              {/* Features List */}
              <div className="mb-8">
                <p className="font-semibold text-foreground mb-4">Everything included:</p>
              ...
              <div className="text-center mb-6">
                <Button variant="hero" size="lg" className="w-full md:w-auto text-lg px-12 py-6 group" asChild>
              ...
              <div className="flex items-center justify-center gap-3 p-4 rounded-xl bg-card border border-primary/20">
                ...
                <div className="text-left">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Not thrilled with your launch? We'll refund your deposit. No questions asked.
                  </p>
                </div>
              </div>
            </div>
