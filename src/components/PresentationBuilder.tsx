...
const useCases = [
  ...
  { icon: Briefcase, text: "Investor or Partnership Pitches that communicate vision clearly" },
  { icon: ShoppingBag, text: "Product Demos or Brand Stories that convert curiosity into customers" },
];
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
              <h2 className="text-4xl md:text-5xl font-display font-bold">
                Generate High-Converting Presentations, Masterclasses, or Pitches <span className="bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent animate-glow">In Minutes</span>
              </h2>

              <p className="text-muted-foreground leading-relaxed">
                Skip the writer's block, endless slide revisions, and copy-and-paste templates. 
                Our AI Presentation Engine transforms your business details into a fully-built, conversion-optimized deck.
              </p>

              <div className="space-y-3 pt-4">
                <p className="font-semibold text-foreground">You can instantly generate:</p>
                {useCases.map((useCase, index) => (
                  <div key={index} className="flex items-start gap-3 p-3 rounded-lg hover:bg-card/50 transition-smooth">
