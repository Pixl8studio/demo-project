...
import logo from "@/assets/growth-mastery-logo.png";
    ...
    <section className="relative min-h-screen gradient-hero overflow-hidden">
      ...
      <div className="container relative mx-auto px-6 py-20 lg:py-32">
        ...
        <div className="flex justify-center mb-12 animate-fade-in">
          <img src={logo} alt="GrowthMastery.ai" className="h-20 w-20 animate-float" />
        </div>
        ...
        <div className="max-w-5xl mx-auto text-center space-y-8">
          ...
          <p className="text-xl md:text-2xl text-muted-foreground max-w-3xl mx-auto leading-relaxed animate-fade-in" style={{ animationDelay: "0.2s" }}>
            The world's first go-to-market engine that designs, builds, and deploys your entire funnel and marketing assets 
            so you can automate sales in hours, not months.
          </p>

          {/* CTA Buttons */}
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center animate-fade-in" style={{ animationDelay: "0.4s" }}>
            <Button size="lg" variant="hero" className="group text-lg px-8 py-6" asChild>
          ...
          <div className="pt-12 animate-fade-in" style={{ animationDelay: "0.6s" }}>
            ...
            <div className="flex flex-wrap justify-center items-center gap-8 opacity-70">
              <div className="px-6 py-3 rounded-lg bg-card/50 backdrop-blur-sm shadow-soft">
                <p className="font-semibold text-foreground">100s of Founders Served</p>
              </div>
              <div className="px-6 py-3 rounded-lg bg-card/50 backdrop-blur-sm shadow-soft">
                <p className="font-semibold text-foreground">$10M+ Generated Online</p>
              </div>
            </div>
          </div>
        </div>
