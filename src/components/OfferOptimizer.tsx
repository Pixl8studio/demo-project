              ...
              <div className="relative aspect-square rounded-3xl bg-gradient-to-br from-muted to-muted/50 p-8 shadow-float">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="relative w-full h-full">
                    ...
                    <div className="absolute top-1/2 right-1/4 p-4 rounded-xl bg-card shadow-soft animate-float" style={{ animationDelay: "1s" }}>
                      <TrendingUp className="w-8 h-8 text-accent" />
                    </div>
                    <div className="absolute bottom-1/4 left-1/3 p-4 rounded-xl bg-card shadow-soft animate-float" style={{ animationDelay: "2s" }}>
            ...
            <div className="space-y-6">
              <div>
                <h2 className="text-4xl md:text-5xl font-display font-bold mb-4">
                  Craft an Irresistible <span className="bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent animate-glow">Scalable Offer with AI</span>
                </h2>
              ...
              <p className="text-muted-foreground leading-relaxed">
                Our Offer Intelligence Engine continuously studies your business, your audience, and the entire marketplace — 
                revealing exactly how to evolve your offer for maximum resonance, profitability, and growth.
              </p>
